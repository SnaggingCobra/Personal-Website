      ...
      <nav className="w-full max-w-4xl px-8 py-4 glass-panel-light backdrop-blur-3xl rounded-full border border-white/20 shadow-2xl pointer-events-auto">
        <div className="flex items-center justify-between gap-12">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm text-slate-300 font-medium">
            ...
            <a href="mailto:contact@prajwolgynawali.com.np" className="rounded-full bg-indigo-500/20 border border-indigo-500/50 px-5 py-2.5 text-indigo-100 hover:bg-indigo-500 hover:text-white transition shadow-[0_0_15px_rgba(99,102,241,0.3)] hover:shadow-[0_0_25px_rgba(99,102,241,0.6)]">
              Email
            </a>
          </div>
        </div>
